...
import { logo, logo2, menu } from '../Images/Images';
...
const Navbar = () => {
    ...
    return (
        <div>
            <div className='shadow-md xl:py-[10px] header relative bg-[#dddddd7a] md:block hidden' style={{ zIndex: '99999999999' }}>
                <div className='xl:max-w-[1440px] m-auto px-[20px]'>
                    <div className='flex items-center justify-between'>
                        <div>
                           <Link to="/"><img src={logo2} alt='logo' className='xl:w-[118px] w-[150px]' /></Link> 
                        </div>
                        <div>
                            <nav>
                                            ...
                                            <NavLink
                                                ...
                                                className={({ isActive }) =>
                                                    isActive
                                                        ...
                                                        : 'text-black hover:text-custome transition duration-300 font-ubuntu xl:text-[20px] bg-[#ffffff24] px-[20px] py-[10px] rounded-t-[30px]'
                                                }
                                            >
                                                {item.name}
                                            </NavLink>
                        ...
                        <div>
                            <Link to="/contactus" className='text-black hover:text-gold transition duration-300 font-ubuntu xl:text-[20px] bg-white px-[30px] py-[15px] rounded-[5px]'>
                                Contact Us
                            </Link>
                        </div>
                    </div>
