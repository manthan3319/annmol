...
const Home_Slider = () => {
  ...
  return (
    <div className="relative">
      {/* Slider */}
      <Slider {...sliderSettings} className="relative w-full md:h-[600px] h-[750px]">
        <div>
          <img src={marcha_bg} className='w-[100%] md:h-[600px] h-[750px]' alt="Background" />
        </div>
        <div>
          <img src={chana_bg} className='w-[100%] md:h-[600px] h-[750px]' alt="Background" />
        </div>
        <div>
          <img src={marcha_bg} className='w-[100%] md:h-[600px] h-[750px]' alt="Background" />
        </div>
